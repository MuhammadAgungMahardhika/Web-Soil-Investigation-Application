<div class="card-header">
    <div class="row align-items-center">
        ...
        <div class="col">
            ...
            <a id="currentLocation" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Set Manual Location"
                class="btn icon btn-primary mx-1" id="manual-position" onclick="manualLocation()">
